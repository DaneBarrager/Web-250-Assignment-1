<?php
	...
	DEFINE("CLASSNAME", "Web -250 - Fall 2015", 1); //Put your class - course number - section
	DEFINE("STUDENT", "Student: Dane Barrager ", 1); //Just change "Student Name" to your name
	...
	DEFINE("illegalfiles", "® . .. favicon.ico index.html.* index.php *.html *.css *.bak 503.html applications.html bg.png bitnami.css index.bak index.html.bak index.html.en.bak index.html.es.bak index.html.he.bak index.html.ko.bak index.html.pt-br index.html.ro.bak index.html.zh.bak main.css readme.txt index.html.de.bak folderup.png folder.png default.html default.php .htaccess .htpasswd .bash_history .mysql_history", 1);
	DEFINE("illegaldirs", " . .. .cache .ssh icons img indexer_files", 1);
